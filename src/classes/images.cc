...
int BMP::x() { return _dest_rect.x; }
int BMP::y() { return _dest_rect.y; }
...
void PNG::image_width(int new_width) { _src_rect.w = new_width; }
void PNG::image_height(int new_height) { _src_rect.h = new_height; }

void PNG::container_width(int new_width) {
  _width = new_width;
  _dest_rect.w = new_width;
}
void PNG::container_height(int new_height) {
  _height = new_height;
...
void PNG::image_x(int x) { _src_rect.x = x; }
void PNG::image_y(int y) { _src_rect.y = y; }


int PNG::x() { return _dest_rect.x; }
int PNG::y() { return _dest_rect.y; }

void PNG::x(int x) { _dest_rect.x = x; }
void PNG::y(int y) { _dest_rect.y = y; }


int PNG::image_x() { return _src_rect.x; }
int PNG::image_y() { return _src_rect.y; }

int PNG::original_x() { return _original_x; }
int PNG::original_y() { return _original_y; }
